...
from stack import ArrayStack, StackException, LinkedListStack


class ArrayStackTests(TestCase):
    """
    Tests on the ArrayStack class
    """
    def test_push(self):
        """
...
class LinkedListStackTests(TestCase):
    """
    Tests on the LinkedListStack class
    """
    def test_push(self):
        """
        We can push an item on the stack. We should not get an error
